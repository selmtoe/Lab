...
**フィードバック** できたこと・できなかったことをデータとして収集し、次の座学へ反映・改善させる<br>
...
### 1. シミュレータ
**役割：実技と座学の中間**<br>
ブラウザ上で動作する軽量なシミュレータ<br>PCスペックに依存せず、どこでもAIとの対戦や検証が可能
...
### 2. 譜面エディタ
**役割：座学情報の保管**<br>
2画面のテト譜がないから仕方がなく作った<br>シミュレータと相互に連携
...
iframeのおかげでnoteより圧倒的に自由度が高い<br>
これを使って色々面白いことができそう
